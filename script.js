...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function createUserMenu() {
    ...
    const menuOptions = [
      {
        divLeft: "S",
        text: "Sergi González @sergigonzalez1854",
        text2: "Ver tu canal"
      }
    ];
    ...
    userBlock.className = "block-menu";
    userMenu.appendChild(userBlock);

    menuOptions.forEach(function(option) {
      const menuItem = document.createElement("div");
      menuItem.className = "block-item";
      menuItem.innerHTML = 
      `<div class = "user-profile-block"> ${option.divLeft}</div>
      <div class = "block-item-text-container">
    ...
    separator0.className = "menu-separator";
    userMenu.appendChild(separator0);

    const firstBlock = document.createElement("div");
    firstBlock.className = "menu-block1";
    userMenu.appendChild(firstBlock);

    menuOptions1.forEach(function(option) {
      const menuItem = document.createElement("div");
